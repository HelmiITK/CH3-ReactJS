...
export default function FormSearch({ onHandleSearch, onSetSearchTerm, onSearchTerm,  }) {
    return (
        <div className="mt-4 mb-3 p-4 border-2 border-slate-200 rounded-md">
            <form action="">
                ...
                <div className="flex justify-between">
                    <button onClick={onHandleSearch} type="submit" className="mt-4 border-0 bg-cyan-500 text-slate-100 text-center text-lg w-[453px] p-2 rounded-md hover:bg-cyan-600">
                        Search
                    </button>
                    <Link to="/halaman-add">
